...
while(True):
    ...
    if isSendPacketBtnPressed:
        ...
        data['name'] = "Camera1"
        data['dX'] = int(((cX - QcX) * MmtoPixelRatio)/2.1) # Converts pixels to mm (real life measurement)
        data['dY'] = int(((QcY - cY) * MmtoPixelRatio)/2.1) # Converts pixels to mm (real life measurement)
        data['command'] = 1
