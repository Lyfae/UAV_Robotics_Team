...
while(True):
    ...
    if isSendPacketBtnPressed:
        ...
        data['name'] = "Camera1"
        data['dX'] = int((cX - QcX/2) * MmtoPixelRatio) # Converts pixels to mm (real life measurement)
        data['dY'] = int((cY - QcY/2) * MmtoPixelRatio) # Converts pixels to mm (real life measurement)
        data['command'] = 1
